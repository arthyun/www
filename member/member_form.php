...
<h2 class="hidden">양식</h2>

<article id="content">  
<form name="member_form" method="post" action="insert.php" class="join"> 
<h3>회원가입</h3>
<table>
<tr>
...
<tr>
    ...
    <td>
        ...
        <input class="email" type="text" id="email1" name="email1" required> 
        &nbsp; @ &nbsp;
        <label class="hidden" for="email2">이메일주소</label>
        <input class="email" type="text" name="email2" id="email2" required>
    </td>
</tr>
<tr class="lastTr">
    <td colspan="2">
        <a href="#" class="bottomBtn" onclick="check_input()">가입하기</a>
