<? 
	...
	$row = mysql_fetch_array($result); //레코드를 담는다.
	$item_subject = $row[subject]; //원하는 필드를 불러온다.
...
<? include "../common/sub_header.html" ?>
	  ...
	  <article id="content">
        ...
        <form name="board_form" method="post" action="insert2.php?mode=modify&num=<?=$num ?>&page=<?=$page ?>&scale=<?=$scale ?>"> 
          <div id="write_form">
